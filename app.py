...
# --- 1. Page Config & CSS (No Indentation to avoid black boxes) ---
...
# --- 4. Fixed Top Navigation (Official Logo Link) ---
...
if st.session_state.step.startswith("checking"):
    ...
    st.markdown(f"""<div style="text-align:center; margin-top:100px;"><div class="loader"></div><h2 style="color:#003366;">Verifying Installment {stage}...</h2><p>The Finance Office is verifying your transaction on Payoneer.</p></div>""", unsafe_allow_html=True)
    time.sleep(5)
